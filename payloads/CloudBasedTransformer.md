...
The payload received at the cloud based transformer is identical with [the payload returned by the context manager](CloudBasedContextManager.md#user-content-return-payload).
